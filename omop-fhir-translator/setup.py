...
setup(
    ...
    name='omop-fhir-translator',  # Required
    ...
    description='Translate OMOP <-> FHIR DATA',
    # Optional
    ...
    url='https://github.com/bmeg/iceberg-schema-tools/tree/feature/OMOP-FHIR-Translate',  # Optional
